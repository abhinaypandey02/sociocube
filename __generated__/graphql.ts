...
export type QueryGetRankedAgencyArgs = {
  page: Scalars['Float']['input'];
};
...
export type UpdatePostingInput = {
  ...
  minimumAge?: InputMaybe<Scalars['Float']['input']>;
  minimumFollowers?: InputMaybe<Scalars['Float']['input']>;
  platform?: InputMaybe<PostingPlatforms>;
  price?: InputMaybe<Scalars['Int']['input']>;
  states?: InputMaybe<Array<Scalars['Int']['input']>>;
};
...
export type Usage = {
  __typename?: 'Usage';
  AiSearch: Scalars['Float']['output'];
  GlobalAnnouncement: Scalars['Float']['output'];
  PostingAnnouncement: Scalars['Float']['output'];
};


export type UsagePostingAnnouncementArgs = {
  postingID: Scalars['Int']['input'];
};
...
export type GetFeaturedSellersQuery = { __typename?: 'Query', sellers: Array<{ __typename?: 'User', username?: string | null, name?: string | null, photo?: string | null, bio?: string | null, category?: string | null, instagramStats?: { __typename?: 'InstagramStats', username: string, followers: number, er: number, isVerified: boolean } | null }>, postings: Array<{ __typename?: 'Posting', id: number, price?: number | null, platform: PostingPlatforms, currency?: string | null, title: string, open: boolean, minimumAge?: number | null, maximumAge?: number | null, barter: boolean, applicationsCount: number, minimumFollowers?: number | null, externalLink?: string | null, description: string, deliverables?: Array<string> | null, agency: { __typename?: 'User', photo?: string | null, name?: string | null } }> };
...
export type GetAiSearchUsageQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAiSearchUsageQuery = { __typename?: 'Query', getSubscription: { __typename?: 'SubscriptionGQL', plan?: SubscriptionPlan | null, usages: { __typename?: 'Usage', AiSearch: number } } };
...
export type GetAllPostingsQuery = { __typename?: 'Query', postings: Array<{ __typename?: 'Posting', id: number, maximumAge?: number | null, minimumFollowers?: number | null, inReview: boolean, externalLink?: string | null, gender?: string | null, extraDetails?: string | null, currencyCountry?: number | null, applicationsCount: number, description: string, barter: boolean, minimumAge?: number | null, open: boolean, title: string, currency?: string | null, price?: number | null, createdAt: number, platform: PostingPlatforms, countries?: Array<number> | null, hasApplied?: boolean | null, eligibility?: Eligibility | null, updatedAt: number, deliverables?: Array<string> | null, agency: { __typename?: 'User', id: number, name?: string | null, photo?: string | null, username?: string | null, instagramStats?: { __typename?: 'InstagramStats', isVerified: boolean, username: string } | null }, states: Array<{ __typename?: 'CitySelectOption', value: number, label: string }>, cities: Array<{ __typename?: 'CitySelectOption', value: number, label: string }>, reviews: Array<{ __typename?: 'Review', rating: number, photo?: string | null, username: string }> }> };
...
export type GetUserPostingsQuery = { __typename?: 'Query', postings: Array<{ __typename?: 'Posting', id: number, maximumAge?: number | null, referralEarnings: number, minimumFollowers?: number | null, applicationsCount: number, selectedCount: number, description: string, barter: boolean, minimumAge?: number | null, extraDetails?: string | null, open: boolean, title: string, currency?: string | null, price?: number | null, createdAt: number, platform: PostingPlatforms, updatedAt: number, deliverables?: Array<string> | null, currencyCountry?: number | null, inReview: boolean }> };
...
export type GetPostingsInReviewQuery = { __typename?: 'Query', getPostingsInReview: Array<{ __typename?: 'Posting', id: number, maximumAge?: number | null, minimumFollowers?: number | null, inReview: boolean, externalLink?: string | null, extraDetails?: string | null, currencyCountry?: number | null, applicationsCount: number, description: string, barter: boolean, minimumAge?: number | null, open: boolean, title: string, currency?: string | null, countries?: Array<number> | null, price?: number | null, createdAt: number, platform: PostingPlatforms, hasApplied?: boolean | null, eligibility?: Eligibility | null, updatedAt: number, deliverables?: Array<string> | null, agency: { __typename?: 'User', id: number, name?: string | null, photo?: string | null, username?: string | null, instagramStats?: { __typename?: 'InstagramStats', isVerified: boolean, username: string } | null }, states: Array<{ __typename?: 'CitySelectOption', value: number, label: string }>, cities: Array<{ __typename?: 'CitySelectOption', value: number, label: string }>, reviews: Array<{ __typename?: 'Review', rating: number, photo?: string | null, username: string }> }> };

export type GetSubscriptionQueryVariables = Exact<{ [key: string]: never; }>;


export type GetSubscriptionQuery = { __typename?: 'Query', getSubscriptionLink?: string | null, getSubscription: { __typename?: 'SubscriptionGQL', status?: SubscriptionPlanStatus | null, plan?: SubscriptionPlan | null } };

export type GetRankedAgencyQueryVariables = Exact<{
  page: Scalars['Float']['input'];
}>;


export type GetRankedAgencyQuery = { __typename?: 'Query', agencies: Array<{ __typename?: 'User', id: number, name?: string | null, photo?: string | null, username?: string | null, category?: string | null, bio?: string | null, totalApplications: number, instagramStats?: { __typename?: 'InstagramStats', isVerified: boolean, followers: number, username: string } | null }> };
...
export const GetAiSearchUsageDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetAISearchUsage"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getSubscription"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"usages"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"AiSearch"}}]}},{"kind":"Field","name":{"kind":"Name","value":"plan"}}]}}]}}]} as unknown as DocumentNode<GetAiSearchUsageQuery, GetAiSearchUsageQueryVariables>;
...
export const GetSubscriptionDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetSubscription"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"getSubscription"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"status"}},{"kind":"Field","name":{"kind":"Name","value":"plan"}}]}},{"kind":"Field","name":{"kind":"Name","value":"getSubscriptionLink"}}]}}]} as unknown as DocumentNode<GetSubscriptionQuery, GetSubscriptionQueryVariables>;
export const GetRankedAgencyDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"GetRankedAgency"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"page"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"Float"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","alias":{"kind":"Name","value":"agencies"},"name":{"kind":"Name","value":"getRankedAgency"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"page"},"value":{"kind":"Variable","name":{"kind":"Name","value":"page"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"photo"}},{"kind":"Field","name":{"kind":"Name","value":"username"}},{"kind":"Field","name":{"kind":"Name","value":"category"}},{"kind":"Field","name":{"kind":"Name","value":"bio"}},{"kind":"Field","name":{"kind":"Name","value":"instagramStats"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"isVerified"}},{"kind":"Field","name":{"kind":"Name","value":"followers"}},{"kind":"Field","name":{"kind":"Name","value":"username"}}]}},{"kind":"Field","name":{"kind":"Name","value":"totalApplications"}}]}}]}}]} as unknown as DocumentNode<GetRankedAgencyQuery, GetRankedAgencyQueryVariables>;