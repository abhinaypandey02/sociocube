...
export type NewPostingInput = {
  ...
  maximumAge: Scalars['Float']['input'];
  minimumAge: Scalars['Float']['input'];
  minimumInstagramFollower: Scalars['Float']['input'];
...
export type Posting = {
  ...
  maximumAge: Scalars['Float']['output'];
  minimumAge: Scalars['Float']['output'];
  minimumInstagramFollower: Scalars['Float']['output'];
...
export type GetFeaturedSellersQuery = { __typename?: 'Query', sellers: Array<{ __typename?: 'User', username?: string | null, name?: string | null, photo?: string | null, bio?: string | null, category?: string | null, instagramStats?: { __typename?: 'InstagramStats', username: string, followers: number, er: number } | null }>, posts: Array<{ __typename?: 'GetFeaturedPostsResponse', mediaURL: string, thumbnailURL: string, creatorImage: string, creatorName: string, creatorUsername: string, postURL: string, likes: number, er: number }>, postings: Array<{ __typename?: 'Posting', id: number, price?: number | null, currency?: string | null, title: string, open: boolean, minimumAge: number, maximumAge: number, barter: boolean, applicationsCount: number, minimumInstagramFollower: number, externalLink?: string | null, user?: { __typename?: 'User', photo?: string | null, companyName?: string | null } | null }> };
...
export type GetPostingQuery = { __typename?: 'Query', posting?: { __typename?: 'Posting', id: number, maximumAge: number, minimumInstagramFollower: number, deliverables?: Array<string> | null, externalLink?: string | null, applicationsCount: number, description: string, barter: boolean, minimumAge: number, open: boolean, title: string, currency?: string | null, price?: number | null, createdAt: number, updatedAt: number, user?: { __typename?: 'User', name?: string | null, photo?: string | null, companyName?: string | null, id: number } | null } | null };

export type GetAllPostingsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetAllPostingsQuery = { __typename?: 'Query', postings: Array<{ __typename?: 'Posting', id: number, maximumAge: number, minimumInstagramFollower: number, applicationsCount: number, description: string, barter: boolean, minimumAge: number, open: boolean, title: string, currency?: string | null, price?: number | null, createdAt: number, updatedAt: number, user?: { __typename?: 'User', name?: string | null, photo?: string | null, companyName?: string | null } | null }> };
