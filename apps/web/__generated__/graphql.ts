...
export type GetFeaturedSellersQuery = { __typename?: 'Query', sellers: Array<{ __typename?: 'User', id: number, name?: string | null, photo?: string | null, bio?: string | null, category?: string | null, instagramStats?: { __typename?: 'InstagramStats', username: string, followers: number, er: number } | null }>, posts: Array<{ __typename?: 'GetFeaturedPostsResponse', mediaURL: string, creatorImage: string, creatorName: string, creatorUsername: string, postURL: string, likes: number, er: number }> };
