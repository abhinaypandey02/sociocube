...
export default function PostingCard({
  ...
  const onNext = () => {
    window.scrollBy({
      top: mainRef.current?.clientHeight || 0,
    });
  };
  ...
  return (
    <>
      <div
        ...
        ref={mainRef}
      >
        <div className="h-full flex flex-col overflow-hidden relative border-gray-200 bg-background px-4 lg:rounded-xl lg:border lg:p-8 lg:shadow-md">
